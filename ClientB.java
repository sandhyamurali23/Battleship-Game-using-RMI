...
public class ClientB implements ClientInterface
{
	
	/**
	 * This is a client 2 Class
	 * 
	 * .
	 *
	...
	public int Player(int[][] ocean_grid1,int [][] ocean_grid2,int [][] player_grid1,int[][] player_grid2) throws RemoteException
	{
		...
		*/
		...
		option=stub.grid2(ocean_grid1, ocean_grid2, player_grid1, player_grid2, row, column, row_size, column_size);
	...
	public static void main(String[] args) 
	{
		...
		*/
		...
		{  
			...
			stub.ClientB_object((ClientInterface) UnicastRemoteObject.exportObject(client2,0));
			client2.initialise();
			client2.fleet1(stub);		 
